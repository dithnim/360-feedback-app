...
import coverRect1 from "../../report/imgs/templates/Cover-2-rec1.svg";
import coverRect2 from "../../report/imgs/templates/Cover-2-rec2.svg";
    ...
    <div className="content-wrapper">
      ...
      <div ref={pdfSectionRef}>
        <div className="pdf-page text-left cover-page-new">
          ...
          <div className="cover-background-shapes">
            <img
              src={coverRect1}
              alt=""
              className="cover-rect absolute top-0"
            />
            <img
              src={coverRect2}
              alt=""
              className="cover-rect absolute bottom-0"
            />
          </div>
          ...
          <div className="cover-header">
            <div className="cover-logos">
              <img
                src={coverLogo}
                alt=""
                className="cover-logo right-20 top-0 w-[335px] h-[87px] absolute"
              />
            </div>

            <div className="cover-user-info">
              {!isEditMode ? (
                <p className="user-date-info mt-30">
          ...
          <div className="cover-main-content flex justify-between items-center  pe-20">
            ...
            <div className="cover-right-section">
              ...
              <div className="cover-circle-image">
                <div className="circle-placeholder">
                  ...
                  {reportLogo ? (
                    <img src={reportLogo} alt="Cover" className="circle-img" />
                  ) : (
                    <svg
                      width="300"
                      height="300"
