    ...
    <>
     {/* Detailed Feedback Section */}
            ...
            <div className="flex flex-row justify-between items-center mb-2">
              <span className="font-semibold text-lg">{props.competency}</span>
              <span className="font-semibold text-lg">
                Average Rating: <span className="text-red-600">{props.averageRating}</span>
              </span>
            </div>
            <table
                                ...
                                >
                                  <div className="me-4 flex flex-col">
                                    ...
                                    <input
                                      ...
                                      onChange={(e) => {
                                        const newQuestions = [...props.questions];
                                        newQuestions[qIndex].ratings[rIndex].rater = e.target.value;
                                        props.onQuestionsChange?.(newQuestions);
                                      }}
                                    />
                                  </div>
                                  <div className="me-4 flex flex-col">
                                    ...
                                    <input
                                      ...
                                      onChange={(e) => {
                                        const newQuestions = [...props.questions];
                                        newQuestions[qIndex].ratings[rIndex].rating = parseFloat(e.target.value);
                                        props.onQuestionsChange?.(newQuestions);
                                      }}
                                    />
                                  </div>
